...
import { faCheck, faCheckCircle, faSortAlphaDownAlt} from '@fortawesome/free-solid-svg-icons';

import { MeasurementGuide, WhatType } from './FixedPanelShowerScreen';

import Swal from 'sweetalert2';

export default class _2xPanelInlineScreen extends Component {
  ...
  addToCart() {
    ...
    data.append('product', '2 Panel Inline Shower Screen - Fixed Panel + Wall Hung Door');
  ...
  calculate() {
    ...
    const total = this.state.doorPanelWidth + this.state.fixedPanelWidth + this.state.gaps;

    const difference = parseInt(this.state.showerWidth) - total;

    const price = this.state.doorPanelPrice + this.state.fixedPanelPrice;
  ...
  render() {
    ...
    const valid = this.state.showerWidth > 0 && ( this.state.doorPanel > 0 || this.state.fixedPanel > 0 ) && ( this.state.difference >= 0 && this.state.difference <= 5 ); 
      ...
      <Fragment>
        ...
        {/*<FormGroup row>
          ...
          <Col md={9}>
            ...
            <MeasurementGuide img={ this.state.image } text="See shower measurement guide for illustration." />
          </Col>

          <Col md={3}><Input type="text" name="showerWidth" onChange={ this.change } value={ this.state.showerWidth } /></Col>
        ...
        <FormGroup row>
          ...
          <Col md={9}>
            <strong>Step 1: Select Fixed Panel Length.</strong>
          </Col>
        ...
        <FormGroup row>
          ...
          <Col md={9}>
            <strong>Step 2: Select Glass Door Length.</strong>
          </Col>
        ...
        {/* <FormGroup row>
          ...
          <Col md={9}>
            This is the total length of glass door and hinge panel combined:<br />
            <i className="text-danger">Note: 9mm are added to the measurement to allow for bracket fittings</i>
          </Col>
        ...
        {/* <FormGroup row>
          ...
          <Col md={9}>
            Overall Shower Length Minus Total Length.<br /><i className="text-danger">Note: This figure should be 0 or more but no more than 5mm</i>
          </Col>
...
class Bracket extends Component {
  ...
  addHingeToCart() {
    ...
    const hingePrice = this.state.hingePrice;
    const doorKnobPrice = this.state.doorKnobPrice;

    if ( hingePrice > 0 && doorKnobPrice > 0 ) {
        ...
        <div className="modal-body" id="modal-body">
                  ...
                  return (
                    ...
                    <div className="extras mr-1 mb-1 border border-secondary p-2 flex-grow-1">
                      ...
                      <div className="main">
                        ...
                        <Button onClick={ () => this.extraAddToCart( x ) } className="w-100 d-block" color="secondary">Add To Cart</Button>
            ...
            this.state.hingeAdded && this.state.doorKnobAdded ?
              ...
              this.state.hinge ?
                ...
                <Fragment>
                  ...
                  <h4 onClick={ this.open } style={ { cursor: 'pointer' } } className="text-center mt-2 mb-4">Choose preferred colour for 90 Wall To Glass Hinge and Door Knob?</h4>
                  ...
                  <Row className="brackets pt-4">
                    ...
                    <Col>
                      ...
                      <div className="border border-secondary p-2 mb-4">
                        ...
                        <p className="font-weight-bold text-center">90 Wall To Glass Hinge</p>

                        <p className="text-center"><img src={ this.state._90_degree_glass_wall_image } style={ { height: '72px' } } /></p>

                      </div>

                      <p className="price">{ formatter.format(_90_degree_hinge_price) }</p>

                      <p className="text-success"><FontAwesomeIcon className="mr-2" icon={faCheck} /> Estimated delivery 3-7 working days</p>

                      <ul className="ml-0 pl-0">
                        { _90_degree_hinge.map( b => {
            ...
            <Fragment>
              ...
              <Row className="brackets pt-4">
                ...
                <Row className="desktop-hidden mb-4 mt-4">
