...
export default class _3xPanelSquareFrontAndReturnScreenHingePanelDoorFixedPanel extends Component {
  ...
  constructor( props ) {
    ...
    this.state = {
      ...
      totalFixedPanel: 0,
      price: 0,
      image: '/wp-content/uploads/2021/09/Front-return-screen-pictorial.jpg',
  ...
  addToCart() {
    ...
    data.append('product', '3 x Panel Square (Front and Return) Screen – Hinge Panel + Door + Fixed Panel');
  ...
  calculate() {
    ...
    const totalFixedPanel =  this.state.fixedPanelWidth + this.state.fittings;
    ...
    this.setState( { total, difference, price, totalFixedPanel } );
    ...
    return (
      ...
      <Fragment>
        ...
        {/* <FormGroup row>
          ...
          <Col md={8}>
            <strong>Step 1: What is the overall width of your shower.</strong> <MeasurementGuide text="See shower measurement guide for illustration." img={ this.state.image } />
          </Col>

          <Col><Input type="text" name="showerWidth" onChange={ this.change } value={ this.state.showerWidth } /></Col>
        ...
        <FormGroup row>
          ...
          <Col md={8}>
            <strong>Step 1: Select Hinge Panel Length (Front).</strong>
          </Col>
        ...
        <FormGroup row>
          ...
          <Col md={8}>
            <strong>Step 2: Select Door Panel Length (Front).</strong>
          </Col>
        ...
        <FormGroup row>
          ...
          <Col md={8}>
            <strong>Step 3: Select Return Panel Length (Return).</strong>
          </Col>
        ...
        {/* <FormGroup row>
          ...
          <Col md={8}>
            <strong>This is the Total Length of glass door and hinge panel combined:</strong><br /><i className="text-danger">Note: 19mm are added to the measurement to allow bracket fittings and the return glass panel thickness:</i>
          </Col>
        ...
        <FormGroup row>
          ...
          <Col md={8}>
            <strong>This is the Total Length of the Fixed Panel Return:</strong><br /><i className="text-danger">Note: 3mm are added to the measurement to allow for bracet fittings</i>
          </Col>

          <Col>
            <Input type="text" value={ this.state.totalFixedPanel } readonly={ true } />
          </Col>
        ...
        <FormGroup row>
          ...
          <Col md={8}>
            <strong>Overall Shower Width Minus Total Width Minus Total Length (Front).</strong><br /><i className="text-danger">This figure should be 0 or more but no more than 3mm</i>
          </Col>
        ...
        <Row>
          <Col md={5}>
            ...
            {/* <span className="price">{ formatter.format( this.state.price ) }</span> */}
            
          </Col>
          <Col md={3} className="mr-0 pr-0">
            <Input type="number" name="quantity" value={ this.state.quantity} onChange={ this.change } /></Col>
