...
export default class _3panelInlineScreenHingPanelDoorFixedPanel extends Component {
  ...
  constructor( props ) {
    ...
    this.state = {
      ...
      price: 0,
      totalPrice: 0,
      image: '/wp-content/uploads/2021/09/3-panel-Inline-Glass-Shower-Screen-Hinge-Fixed-and-Door-Panel-pictorial.jpg',
    ...
    this.selectFixedPanel = this.selectFixedPanel.bind(this);
  ...
  addToCart() {
    ...
    data.append('product', '3 x Panel Inline Screen – Hinge Panel + Door + Fixed Panel');
    ...
    data.append('fixedPanel', this.state.fixedPanel);
    data.append('fixedPanelPrice', this.state.fixedPanelPrice);
    data.append('fixedPanelCode', this.state.fixedPanelCode);
    data.append('fixedPanelWidth', this.state.fixedPanelWidth);
    ...
    .then( response => {
      ...
      if ( response.success ) {
        ...
        Swal.fire({
          ...
          timer: 1500,
          title: '3 x Panel Square (Front and Return) Screen – Hinge Panel + Door + Fixed Panel has been added to your cart'
        })
  ...
  calculate() {
    ...
    const total = this.state.doorPanelWidth + this.state.hingePanelWidth + this.state.fixedPanelWidth + this.state.gaps;

    const difference = parseInt(this.state.showerWidth) - total;

    const price = this.state.doorPanelPrice + this.state.hingePanelPrice + this.state.fixedPanelPrice;

    const totalPrice = price * this.state.quantity;

    this.setState( { total, difference, price, totalPrice } );
  ...
  selectFixedPanel( e ) {
    ...
    const fixedPanel = parseInt(panel[0].id);
    const fixedPanelWidth = parseInt(panel[0].width);
    const fixedPanelPrice = parseInt(panel[0].price);
    const fixedPanelCode = panel[0].code;

    this.setState( { fixedPanel, fixedPanelWidth, fixedPanelCode, fixedPanelPrice }, () => this.calculate() );
  ...
  render() {
    ...
    const fixedPanels = panels.filter( p => p.category === 'Fixed Panel');

    const valid = this.state.showerWidth > 0 && ( this.state.doorPanel > 0 || this.state.hingePanel > 0 ) && ( this.state.difference >= 0 && this.state.difference <= 5 ); 
    ...
    return (
      ...
      <Fragment>
        ...
        {/* <FormGroup row>
          ...
          <Col md={8}>
            <strong>Step 1: What is the overall width of your shower.</strong><br />
            <i><MeasurementGuide text="See shower measurement guide for illustration." img={ this.state.image } /></i>
          </Col>
        ...
        <FormGroup row>
          ...
          <Col md={8}>
            <strong>Step 1: Select Hinge Panel Length.</strong>
          </Col>

          <Col md={4}>
            <Input name="hingePanel" onChange={ this.selectHingePanel } type="select">
        ...
        <FormGroup row>
          ...
          <Col md={8}>
            <strong>Step 2: Select Glass Door Panel Length.</strong>
          </Col>
        ...
        <FormGroup row>
          ...
          <Col md={8}>
            <strong>Step 3: Select Fixed Panel Length.</strong>
          </Col>

          <Col md={4}>
            <Input name="fixedPanel" onChange={ this.selectFixedPanel } type="select">
              <option value="">select</option>
              {
                  fixedPanels.map( d => {
        ...
        {/* <FormGroup row>
          ...
          <Col md={8}>
            This is the <strong>total length</strong> of glass door, hinge panel and fixed panel combined:<br /><i className="text-danger">Note: 12mm are added to the measurement to allow for bracket fillings</i>
          </Col>
        ...
        <FormGroup row>
          ...
          <Col md={8}>
            <strong>Overall Shower Length Minus Total Length.</strong><br /><i className="text-danger">Note: This figure should be 0 or more but no more than 5mm</i>
          </Col>
        ...
        <FormGroup row>
          <Col md={5}>
            ...
            <h5>Total: { formatter.format(this.state.totalPrice) }</h5>
          </Col>
          <Col md={3} className="pr-0">
            <Input type="number" name="quantity" onChange={ this.change } value={ this.state.quantity } />
          </Col>

          <Col md={3}>
            <Button onClick={ this.addToCart } color="primary">Add To Cart</Button>
          </Col>
        </FormGroup>
...
class Bracket extends Component {
  ...
  constructor( props ) {
    ...
    this.state = {
      ...
      bracket_90_quantity: 4,
      bracket_180_quantity: 4,
      hinge_quantity: 2,
      doorknob_quantity: 1,
      waterbar_quantity: 1
      ...
      <Modal isOpen={ this.props.open } toggle={ this.props.close } className="mw-100  mt-4">
        ...
        <div className="modal-header text-center">
            ...
            {/* <div style={ { fontSize: '20px'} }>
              ...
              "3 x Panel Square (Front and Return) Screen – Hinge Panel + Door + Fixed Panel" has been added to your cart
              ...
              <Fragment>
                ...
                { this.props.extras.map( x => {
                  ...
                  return (
                    ...
                    <div className="extras mr-1 mb-1 border border-secondary p-2 flex-grown-1">
